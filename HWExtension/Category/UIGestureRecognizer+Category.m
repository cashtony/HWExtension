...
const void *HWUIGestureRecognizerHandlersKey = &HWUIGestureRecognizerHandlersKey;
    ...
    @synchronized(self) {
        ...
        if (handlers && handlers.count) {
            if (handler) {
                ...
                [handlers enumerateKeysAndObjectsUsingBlock:^(HWUIGestureRecognizerHandler key, HWUIGestureRecognizerTarget *obj, BOOL * stop) {
