...
typedef void (^InteractiveHandler)(UIGestureRecognizer *sender, UIGestureRecognizerState state, CGPoint location);

@interface HWXYGraphInteractionView : UIView

@property (nonatomic, assign) CGRect contentRect;                   //

@property (copy, nonatomic) InteractiveHandler interactiveHandler;  // 交互回调block
...
- (id)initWithFrame:(CGRect)frame interactiveHandler:(InteractiveHandler)handler;  // 初始化
