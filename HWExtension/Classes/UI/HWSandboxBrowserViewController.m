...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:nil indexPath:indexPath nilBlock:^__kindof UITableViewCell * _Nonnull(NSIndexPath * _Nonnull indexPath) {
    ...
    cell.imageView.image = [UIImage imageNamed:isDirectory ? @"icon_directory.jpg" : @"icon_file.jpg"];
    ...
    cell.detailTextLabel.text = [modiDate stringWithFormat:@"yyyy.MM.dd HH:mm:ss.SS"];
